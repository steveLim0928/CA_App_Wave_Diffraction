...
def start_animation():
    global reset, reset_z, num, gap, x, offset, width 
...
bottom_canvas = Tkinter.Canvas(upper_frame, width = 950, height = 20, bg = 'light grey',
...
home_button = Tkinter.Button(upper_frame, text = 'Home', command = get_home, 
                              state = 'normal', pady = 3, padx = 5, bd = 3)
home_button.place(x = 880, y = 545)

back_button = Tkinter.Button(upper_frame, text = 'Back', command = get_back,
                             state = 'normal', pady = 3, padx = 5, bd = 3)
back_button.place(x = 10, y = 545)
