...
#LABEL
text1 = Label(root, text = 'INSTRUCTION FOR QUIZ', font =('algerian',30,'underline'), bg = 'skyblue')
...
4)Once you selected your answer, you will straight away be
   directed to the next question.\n
5)Once you selected your answer, you cannot go back to the
  previous question anymore.\n
...
text3= Label(root, text ="CLICK THIS ARROW TO GO BACK", font =('algerian',10),fg='red',bg ='skyblue')
text3.place(x =10 , y =570)

text4= Label(root, text ="CLICK THIS ARROW FOR QUIZ", font =('algerian',10),fg='red',bg ='skyblue')
text4.place(x =510 , y =570)

text5= Label(root, text = "GOOD LUCK!",font =('algerian',30,'bold'),bg ='skyblue')
text5.place(x= 240,y=500)



#BUTTON
Button(root, image = nextbb,height=75,width=75,borderwidth = 0,bg = 'skyblue', activebackground = 'skyblue',command = quiz).place(x= 600, y = 600)
Button(root, image=backbb,height=75, width = 75,borderwidth = 0,bg = 'skyblue', activebackground = 'skyblue', command = mainpage).place(x=20, y =600)
