...
upper_frame = Tkinter.Frame(root, width = 950, height = 550, bg = 'grey')
upper_frame.place(x = 0, y = 0)

image = Image.open('animation_background4.jpg')
image = image.resize((950, 550), Image.ANTIALIAS)
...
width_slider = Tkinter.Scale(upper_frame, from_ = 20, to = 50, resolution = 1, 
                           ...
                           orient = 'horizontal', length = 150)
width_slider.place(x = 750, y = 250)
