            ...
            if num == 1:
                ...
                if x <= 250:
                    ...
                    if x2 == 290 + offset:
                        ...
                        DSG.DS_Graph1(graph_canvas, a, (10 + gap), 'red')
...
def get_result():
    ...
    Calculation2.double_calculation(calculation_gap, calculation_offset, wavelength, answer_canvas)
...
DSr.barrier(canvas2, gap_slider.get() * 100, width_slider.get() * 200)
