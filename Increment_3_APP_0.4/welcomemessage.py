...
c.create_text(350,50,text = "Welcome to this workshop!",font = ('Bahnschrift SemiBold',20),fill = 'white',justify = CENTER)
...
colour = ('#{:02x}{:02x}{:02x}').format(int(88), int(88), int(88))
