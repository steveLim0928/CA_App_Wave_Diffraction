...
def double_calculation(gap, offset, wavelength, canvas):
    ...
    theta_value = (((math.asin(float((((n*LAMBDA)/A)/1000000000)))))*D)
    bright_value = ((((math.asin(float(((n*LAMBDA)/A)/1000000000))))))
    dark_value = ((((math.asin(float(((n+(0.5)*LAMBDA)/A)/1000000000))))))
...
def single_calculation(gap, offset, wavelength, canvas):
    ...
    bright_value = ((((math.asin(float(((n+(0.5)*LAMBDA)/A)/1000000000))))))
    dark_value =  ((((math.asin(float(((n*LAMBDA)/A)/1000000000))))))
