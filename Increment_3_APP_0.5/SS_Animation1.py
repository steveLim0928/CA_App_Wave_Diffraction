...
def reset_animation():
    global reset, status, x, reset_z, canvas3, x2, canvas4
...
answer_canvas = Tkinter.Canvas(upper_frame, width = 320, height = 100, bg = 'sky blue')
answer_canvas.place(x = 450, y = 420)
