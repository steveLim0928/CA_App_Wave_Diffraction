...
def answer(gap, offset, wavelength, canvas):
    ...
    canvas.create_text(130, 20, text = ('Value of n = ' + n1), fill = 'red', font = ('Arial', 12))
    
    canvas.create_text(80, 40, text = ('Theta = ' + theta_value + ' rad'), fill = 'black', font = ('Arial', 12))
    
    canvas.create_text(155, 60, text = ('Distance between bright fringes = ' + bright_value + ' mm'), fill = 'black', font = ('Arial' ,12))
    
    canvas.create_text(150, 80, text = ('Distance between dark fringes = ' + dark_value + ' mm'), fill = 'black', font = ('Arial', 12))
